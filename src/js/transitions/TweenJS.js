...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define('transitions/TweenJS', ['jquery', '../nodes/BaseNode', 'utils/Events'], factory);
    ...
    var animateTween = function (startProperties, endProperties, value) {
        var result = {};
        var property;
        var temp;
        ...
        for (property in endProperties) {
            if (endProperties.hasOwnProperty(property) && startProperties.hasOwnProperty(property)) {
                ...
                if (typeof endProperties[property] === 'string' && typeof startProperties[property] === 'number') {
                    ...
                    temp = animateTween(startProperties[property], endProperties[property], value);
                } else {
                    temp = (true) // TODO:: bug
    ...
    Tween.prototype.update = function (time) {
        ...
        if (time < tween.data.startTime || tween.data.endProperties === null) return true;
        ...
        tween.node.import(
            animateTween(tween.data.startProperties, tween.data.endProperties, tween.data.easingFunction(elapsed))
        );
    ...
    if (typeof module === 'object' && typeof module.exports === 'object') module.exports.TweenJS = Tween;
    if (global.j2d === undefined) global.j2d.transitions.TweenJS = Tween;
    return Tween;
}))
;

...
!function (global) {
    ...
    function newContext(e) {
        ...
        function r(e, r, i) {
            var n, o, a, s, u, c, d, p, f, l, h, m, g = r && r.split("/"), v = w.map, x = v && v["*"];
        ...
        function a(e, t, i, n) {
            ...
            return e || (l = !1, e = "_@r" + (A += 1)), c = o(e), d = c[0], e = c[1], d && (d = r(d, p, n), s = getOwn(j, d)), e && (d ? h = s && s.normalize ? s.normalize(e, function (e) {
                return r(e, p, n)
            }) : -1 === e.indexOf("!") ? r(e, p, n) : e : (h = r(e, p, n), c = o(h), d = c[0], h = c[1], i = !0, a = q.nameToUrl(h))), u = !d || s || i ? "" : "_unnormalized" + (T += 1), {
                prefix: d,
                name: h,
                parentMap: t,
                unnormalized: !!u,
        ...
        function s(e) {
            var t = e.id, r = getOwn(S, t);
            return r || (r = S[t] = new q.Module(e)), r
        }

        function u(e, t, r) {
            var i = e.id, n = getOwn(S, i);
        ...
        function f(e, t, r) {
            ...
            e.error ? e.emit("error", e.error) : (t[i] = !0, each(e.depMaps, function (i, n) {
                var o = i.id, a = getOwn(S, o);
                !a || e.depMatched[n] || r[o] || (getOwn(t, o) ? (e.defineDep(n, j[o]), e.check()) : f(a, t, r))
            }), r[i] = !0)
        }

        function l() {
            var e, t, r = 1e3 * w.waitSeconds, o = r && q.startTime + r < (new Date).getTime(), a = [], s = [], u = !1, d = !0;
            if (!x) {
                if (x = !0, eachProp(k, function (e) {
                        var r = e.map, c = r.id;
                        if (e.enabled && (r.isDefine || s.push(e), !e.error))if (!e.inited && o)n(c) ? (t = !0, u = !0) : (a.push(c), i(c)); else if (!e.inited && e.fetched && r.isDefine && (u = !0, !r.prefix))return d = !1
        ...
        return E = {
            ...
            init: function (e, t, r, i) {
                            ...
                            if (this.defining = !0, this.depCount < 1 && !this.defined) {
                                if (isFunction(o)) {
                                    ...
                                    if (this.map.isDefine && void 0 === n && (t = this.module, t ? n = t.exports : this.usingExports && (n = this.exports)), e) {
                                        if (this.events.error && this.map.isDefine || req.onError !== defaultOnError)return e.requireMap = this.map, e.requireModules = this.map.isDefine ? [this.map.id] : null, e.requireType = this.map.isDefine ? "define" : "require", c(this.error = e);
                ...
                this.depMaps.push(i), u(i, "defined", bind(this, function (i) {
                    ...
                    return this.map.unnormalized ? (i.normalize && (l = i.normalize(l, function (e) {
                        ...
                        i && (r = i), d && (useInteractive = !1), s(u), hasProp(w.config, t) && (w.config[o] = w.config[t]);
                        try {
                            req.exec(r)
                        } catch (p) {
            ...
            configure: function (e) {
                ...
                var t = w.shim, r = {paths: !0, bundles: !0, config: !0, map: !0};
                eachProp(e, function (e, t) {
                    r[t] ? (w[t] || (w[t] = {}), mixin(w[t], e, !0, !0)) : w[t] = e
                }), e.bundles && eachProp(e.bundles, function (e, t) {
                    each(e, function (e) {
                        e !== t && (R[e] = t)
                    })
                }), e.shim && (eachProp(e.shim, function (e, r) {
                    isArray(e) && (e = {deps: e}), !e.exports && !e.init || e.exportsFn || (e.exportsFn = q.makeShimExports(e)), t[r] = e
                }), w.shim = t), e.packages && each(e.packages, function (e) {
                    var t, r;
            ...
            makeRequire: function (t, n) {
                function o(r, i, u) {
                    ...
                    return n.enableBuildCallback && i && isFunction(i) && (i.__requireJsBuild = !0), "string" == typeof r ? isFunction(i) ? c(makeError("requireargs", "Invalid require call"), u) : t && hasProp(E, r) ? E[r](S[t.id]) : req.get ? req.get(q, r, t, o) : (p = a(r, t, !1, !0), d = p.id, hasProp(j, d) ? j[d] : c(makeError("notloaded", 'Module name "' + d + '" has not been loaded yet for context: ' + e + (t ? "" : ". Use require([])")))) : (v(), q.nextTick(function () {
                        v(), f = s(a(null, t)), f.skipMap = n.skipMap, f.init(r, i, u, {enabled: !0}), l()
                    }), o)
                }

                return n = n || {}, mixin(o, {
                    isBrowser: isBrowser, toUrl: function (e) {
                        var i, n = e.lastIndexOf("."), o = e.split("/")[0], a = "." === o || ".." === o;
                        return -1 !== n && (!a || n > 1) && (i = e.substring(n, e.length), e = e.substring(0, n)), q.nameToUrl(r(e, t && t.id, !0), i, !0)
                    }, defined: function (e) {
                    ...
                    d();
                    var r = a(e, t, !0), n = getOwn(S, e);
                    n.undefed = !0, i(e), delete j[e], delete P[r.url], delete M[e], eachReverse(O, function (t, r) {
                        t[0] === e && O.splice(r, 1)
            ...
            completeLoad: function (e) {
                var t, r, i, o = getOwn(w.shim, e) || {}, a = o.exports;
                for (d(); O.length;) {
            ...
            nameToUrl: function (e, t, r) {
                var i, n, o, a, s, u, c, d = getOwn(w.pkgs, e);
                if (d && (e = d), c = getOwn(R, e))return q.nameToUrl(c, t, r);
                if (req.jsExtRegExp.test(e))s = e + (t || ""); else {
                    for (i = w.paths, n = e.split("/"), o = n.length; o > 0; o -= 1)if (a = n.slice(0, o).join("/"), u = getOwn(i, a)) {
                        isArray(u) && (u = u[0]), n.splice(0, o, u);
                        break
                    }
                    s = n.join("/"), s += t || (/^data\:|\?/.test(s) || r ? "" : ".js"), s = ("/" === s.charAt(0) || s.match(/^[\w\+\.\-]+:/) ? "" : w.baseUrl) + s
                }
    ...
    if ("undefined" == typeof define) {
        ...
        "undefined" == typeof require || isFunction(require) || (cfg = require, require = void 0), req = requirejs = function (e, t, r, i) {
            ...
            if (isWebWorker)try {
                ...
                e.onError(makeError("importscripts", "importScripts failed for " + t + " at " + r, o, [t]))
            }
            ...
            var i, n;
            "string" != typeof e && (r = t, t = e, e = null), isArray(t) || (r = t, t = null), !t && isFunction(r) && (t = [], r.length && (r.toString().replace(commentRegExp, "").replace(cjsRequireRegExp, function (e, r) {
                t.push(r)

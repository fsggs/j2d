...
(function (root, factory) {
    ...
    test('MathUtil degree2Radian()', function (assert) {
        equal(MathUtil.degree2Radian(60), 60 * (Math.PI / 180));
    });

    test('MathUtil radian2Degree()', function (assert) {
